...
import { updateAppliance } from "../../redux/apiCalls";
...
const Updateappliance = () => {
  ...
  const handleSubmit = (e) => {
    ...
    updateAppliance(id, updateappliance, dispatch);
    toast.success("Appliance Update Successfully!");
  };

  return (
    <form style={{ margin: "20px" }} onSubmit={handleSubmit}>
      <Header title={`UPDATE APPLIANCE`} subtitle="Update  Services " />
      <Box
        display="grid"
        gap="30px"
